  ...
  return (
    ...
    <Header/>
      <div className='container mt-5'>
        ...
        <div className="row mt-5 mb-5">
            ...
            <table className='table shadow mt-3'>
              ...
              <tbody>
                ...
                <tr key={index}>
                  <td>{index+1}</td>
                  <td>{product.title}</td>
                  <td><img style={{height:'80px', width:'80px'}} src={product.thumbnail} alt="" /></td>
                  <td>
          ...
          <div className="col-lg-4 mt-5">
            <div className="shadow border rounded p-4">
              ...
              <h5>Total Amount: <span className='fw-bolder text-danger'>${cartAmount}</span></h5>
              <hr />
        ...
        <img width={'25%'} src="https://www.qrcardboard.com/images/cart.gif?" alt="" />
        <h1 className='overflow-hidden'>Your Cart is Empty!!!</h1>
